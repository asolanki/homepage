...
async function toggleRecord() {
    if (!isRecording) {
        ...
        mediaRecorder.onstop = async () => handleStopRecording();
...
// const RELATIVE_BASE_AUDIO_URL = "../audio/tone-perfect/"

function getAudioUrl() {
    let randomSpeaker = getNextSpeaker();

    // let audioUrl = `../audio/tone-perfect/${currentSound}${currentTone}_${randomSpeaker}_MP3.mp3`;
    let audioUrl = R2_BASE_AUDIO_URL + currentSound + currentTone + "_" + randomSpeaker + "_MP3.mp3";
    return audioUrl;
}
